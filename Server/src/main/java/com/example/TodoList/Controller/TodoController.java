...
public class TodoController {
    ...
    public ResponseEntity<?> summarizeAndSendToSlack(@PathVariable String username) {
        ...
        String mockSummary = "Here is your summary: You have 3 tasks, 2 completed and 1 remaining. Keep up the good work!";
        // Optionally, you can also mock sending to Slack here (or just log it)
        System.out.println("Mock summary sent to Slack: " + mockSummary);
        Map<String, String> response = new HashMap<>();
        response.put("summary", mockSummary);
